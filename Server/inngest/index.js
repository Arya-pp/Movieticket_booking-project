...
export const releaseSeatsAndDeleteBooking = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    return step.run("check-payment-status", async () => {
...
const sendBookingConfirmationEmail = inngest.createFunction(
  ...
  async ({ event, step }) => {
    ...
    subject: `Confirmation: "${booking.show.movie.title}" booked!`,
    body: `
      <div style="font-family: Arial, sans-serif; line-height: 1.5;">
        ...
        <p>Enjoy the show! 🍿</p>
        <p>Thanks for booking with us!<br/>— BookShow Team</p>
      </div>
    `
  });
